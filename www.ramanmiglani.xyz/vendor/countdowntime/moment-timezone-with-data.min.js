! function(c, M) {
    ...
    function z(c) {
        var z = 0,
            ...
            n = 0,
            a = 1;
        for (45 === c.charCodeAt(0) && (z = 1,
                a = -1),
            z; z < b.length; z++)
            n = 60 * n + M(b.charCodeAt(z));
        for (z = 0; z < o.length; z++)
            p /= 60,
            n += M(o.charCodeAt(z)) * p;
        return n * a
    }
    ...
    function q() {
        var c, M, z, A = (new Date).getFullYear() - 2,
            ...
            o = [b];
        for (z = 1; z < 48; z++)
            (M = new a(new Date(A, z, 1))).offset !== b.offset && (c = L(b, M),
                o.push(c),
                o.push(new a(new Date(c.at + 6e4)))),
            b = M;
        for (z = 0; z < 4; z++)
    ...
    function d() {
        ...
        return a.sort(N),
            a.length > 0 ? a[0].zone.name : void 0
    }
    ...
    function f(c, M) {
        c = e(c);
        var z, A = E[c];
        return A instanceof n ? A : "string" == typeof A ? (A = new n(A),
            E[c] = A,
            A) : R[c] && M !== f && (z = f(R[c], f)) ? ((A = E[c] = new n)._set(z),
            A.name = S[c],
            A) : null
    }
    ...
    function r(c) {
        X(c.zones),
            B(c.links),
            t.dataVersion = c.version
    }

    function T(c) {
        return T.didShowError || (T.didShowError = !0,
            u("moment.tz.zoneExists('" + c + "') has been deprecated in favor of !moment.tz.zone('" + c + "')")), !!f(c)
    }
    ...
    function t(M) {
        ...
        return b && !c.isMoment(M) && l(o) && o.add(b.parse(o), "minutes"),
            o.tz(A),
            o
    }
    ...
    (P < 2 || 2 === P && g < 6) && u("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + c.version + ". See momentjs.com"),
        n.prototype = {
            ...
            offset: function(c) {
                return u("zone.offset has been deprecated in favor of zone.utcOffset"),
    ...
    c.tz = t,
        ...
        c.updateOffset = function(M, z) {
            ...
            void 0 === M._z && (b && l(M) && !M._isUTC && (M._d = c.utc(M._a)._d,
                        M.utc().add(b.parse(M), "minutes")),
                    M._z = b),
                M._z && (A = M._z.utcOffset(M),
                    Math.abs(A) < 16 && (A /= 60),
                    void 0 !== M.utcOffset ? M.utcOffset(-A, z) : M.zone(A, z))
        },
        h.tz = function(M, z) {
            return M ? (this._z = f(M),
                this._z ? c.updateOffset(this, z) : u("Moment Timezone has no data for " + M + ". See http://momentjs.com/timezone/docs/#/data-loading/."),
        ...
        c.tz.setDefault = function(M) {
            return (P < 2 || 2 === P && g < 9) && u("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + c.version + "."),
                c.defaultZone = M ? f(M) : null,
                c
        };
    var w = c.momentProperties;
    return "[object Array]" === Object.prototype.toString.call(w) ? (w.push("_z"),
            w.push("_a")) : w && (w._z = null),
        r({
            version: "2017c",
